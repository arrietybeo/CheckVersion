...
public class ReadMessenge : AvMain
{
            ...
            case 3:
                {
                    ...
                    GameCanvas.menu2.startAt_NPC(mVector3, MainObject.strHelpNPC[MainObject.StepHelpServer], subIndex, 2, false, 2);
                    break;
                }
            case 4:
        ...
        try
        {
            ...
            for (int k = 0; k < b; k++)
            {
                ...
                if (b2 > -1)
                {
                    ...
                    MainItem mainItem = MainItem.MainItem_Item(b2, itemName, imageId, plusItem, b6, b3, 3, array2, b4, false, -1, 0L, lvItem, 0, 0, 0, 0, isLock);
                    if (mainObject != GameScreen.player)
                    {
                        continue;
                    }
        ...
        try
        {
            ...
            if (b == SHOP_OTHER_PLAYER)
            {
                ...
                for (int i = 0; i < num; i++)
                {
                    ...
                    if (b2 == 3)
                    {
                        ...
                        MainItem o = MainItem.MainItem_Item(num2, itemName, imageId, plusItem, b5, b3, 3, array, b4, false, num2, 0L, lvItem, 0, 0, 0, typeMoney, 0);
                        mVector3.addElement(o);
                    }
                    if (b2 == 7)
                    {
            ...
            else if (b == SHOP_VANTIEU)
            {
                ...
                for (int k = 0; k < num; k++)
                {
                    ...
                    MainItem o4 = MainItem.MainItem_Item(num6, itemName2, imageId2, 0, b11, b9, 3, array2, b10, false, num6, price2, lvItem2, 0, 0, 0, typeMoney2, 0);
            ...
            else if (b == SHOP_ITEM || b == WING || b == SHOP_ITEM_EVENT)
            {
                ...
                for (int n = 0; n < num; n++)
                {
                    ...
                    MainItem mainItem2 = MainItem.MainItem_Item(num7, itemName3, imageId3, 0, b15, b13, 3, array3, b14, false, num7, price3, lvItem3, 0, 0, 0, typeMoney3, 0);
            ...
            else if (b == SHOP_HAIR)
            {
                ...
                for (int num9 = 0; num9 < num; num9++)
                {
                    ...
                    MainItem o6 = MainItem.MainItem_Toc(num10, itemName4, imageId4, 0, 6, array4, false, num10, price4, priceType, 0, 0);
    ...
    public void itemTemplate(Message msg)
    {
        try
        {
            ...
            for (int i = 0; i < num; i++)
            {
                short num2 = msg.reader().readShort();//id
                short iconId = msg.reader().readShort();//icon
                long price = msg.reader().readLong();
                string name = msg.reader().readUTF();
                ...
                string filePath = $"G://item_data.sql";
                string sqlQuery = $"INSERT INTO `potion_item` (`id`, `icon`, `price`, `name`, `content`, `typepotion`, `moneytype`, `sell`, `value`, `canTrade`) " +
                          $"VALUES ({num2}, {iconId}, {price}, '{name}', '{content}', {typepotion}, {moneytype}, {sell}, {value}, {canTrade});\n";
                File.AppendAllText(filePath, sqlQuery);
            }
            ...
            for (int j = 0; j < num3; j++)
            {
                ...
                string file = $"G://item_option.sql";
                string sqlQuery = $"INSERT INTO `item_option` (`id`, `name`, `color`, `type`) " +
                          $"VALUES ({j}, '{Item.nameInfoItem[j]}', {Item.colorInfoItem[j]}, {Item.isPercentInfoItem[j]});\n";

                File.AppendAllText(file, sqlQuery);
            }
            short num4 = msg.reader().readShort();
            for (int k = 0; k < num4; k++)
            {
                ...
                string file = $"G://material_item.sql";
                string sqlQuery = $"INSERT INTO `material_item` (`id`, `icon`, `price`, `name`, `content`, `typeitem`, `priceType`, `sell`, `value`, `trade`, `color`) " +
                          $"VALUES ({num5}, {imageId}, {price2}, '{itemName}', '{content2}', {typeitem}, {priceType}, {sell2}, {value2}, {trade}, {b});\n";
                File.AppendAllText(file, sqlQuery);
            }
            ...
            string file2 = $"G://config.sql";
            string sqlQuery2 = $"INSERT INTO `config` (`priceSellPotion`, `priceSellItem`, `hesoLv`, `hesoColor`, `priceSellQuest`, `maxPriceItem`, `PriceIconClan`, `PriceChatWorld`) " +
                          $"VALUES ({TabShopNew.priceSellPotion}, {TabShopNew.priceSellItem}, {TabShopNew.hesoLv}, {TabShopNew.hesoColor}, {TabShopNew.priceSellQuest}, {TabShopNew.maxPriceItem}, {TabShopNew.PriceIconClan}, {TabShopNew.PriceChatWorld});\n";
            File.AppendAllText(file2, sqlQuery2);
            ...
            for (int l = 0; l < b2; l++)
            {
                ...
                string file = $"G://pet_template.sql";
                string sqlQuery = $"INSERT INTO `pet_template` (`id`, `type`) " +
                          $"VALUES ({num6}, {b3});\n";
            ...
            try
            {
                ...
                for (int num29 = 0; num29 < b8; num29++)
                {
                    ...
                    if (num30 > 0)
                    {
                        ...
                        DataEffect o2 = new DataEffect(array, b9, true);
                        mVector3.addElement(o2);
    ...
    public void listChar(Message msg)
    {
        try
        {
            ...
            sbyte b = msg.reader().readByte();// list char
            ...
            for (int i = 0; i < b; i++)
            {
                ...
                int iD = msg.reader().readInt();//id
                string name = msg.reader().readUTF();//name
                sbyte b2 = msg.reader().readByte();//dau
                sbyte b3 = msg.reader().readByte();//toc
                sbyte b4 = msg.reader().readByte();//mat
                sbyte b5 = msg.reader().readByte();// item wear
                sbyte[] array = new sbyte[12];
    ...
    public void get_Item_Tem(Message msg)
    {
        try
        {
            short num = msg.reader().readShort();// id item
            string name = msg.reader().readUTF();// name item
            sbyte typeItem = msg.reader().readByte();// type item
            sbyte idPartItem = msg.reader().readByte();// part item
            sbyte classitem = msg.reader().readByte();// class 
            short iconId = msg.reader().readShort();// icon item
            sbyte b = msg.reader().readByte();// size option
            int[] array = new int[b];
            ...
            string filePath = $"G://item.sql";
            string sqlQuery = $"INSERT INTO `item` (`id`, `name`, `typeItem`, `idPartItem`, `classitem`, `iconId`)" +
                      $"VALUES ({num}, {name}, {typeItem}, '{idPartItem}', '{classitem}', {iconId});\n";
            File.AppendAllText(filePath, sqlQuery);

            Debug.LogError("id: " + num + ", name: " + name + ", typeItem: " + typeItem + ", idPartItem: " + idPartItem + ", classitem: " + classitem + ", iconId: " + iconId);
        ...
        try
        {
            ...
            for (int j = 0; j < b; j++)
            {
                ...
                if (b2 > -1)
                {
                    ...
                    MainItem mainItem = MainItem.MainItem_Item(b2, itemName, imageId, plusItem, b6, b3, 3, array2, b4, false, -1, 0L, lvItem, 0, 0, 0, 0, 0);
    ...
    public void update_Status_Area(Message msg)
    {
        try
        {
            ...
            GameCanvas.menu2.startAt(mVector3, 2, T.khuvuc, false, null);
            GameCanvas.end_Dialog();
        }
        catch (Exception)
        {
    ...
    public void List_Serverz(Message msg)
    {
        try
        {
            ...
            string text = "List";
            sbyte b = msg.reader().readByte();// type list
            //Debug.Log("type bxh: " + b);

            text = msg.reader().readUTF();// ten bxh
            sbyte page = msg.reader().readByte();// life 
            int num = msg.reader().readInt();// my index
            ...
            if (b == 3)
            {
                for (int i = 0; i < num2; i++)
                {
                    ...
                    // Debug.Log("name: " + shortname);

                    // Debug.Log("slogan: " + slogan);
    ...
    public void name_server(Message msg)
    {
        try
        {
            ...
            for (int i = 0; i < num; i++)
            {
                ...
                String name = array[i];
                string filePath = "G://KnightAge//" + num + "name_server.txt";
                using (StreamWriter writer = new StreamWriter(filePath, true))
                {
                    writer.WriteLine("id: " + i + " map: [" + name + "]");
                }
            }
            ...
            for (int j = 0; j < b; j++)
            {
                ...
                string filePath = "G://KnightAge//" + b + " nameItemQuest.txt";
                using (StreamWriter writer = new StreamWriter(filePath, true))
                {
                    writer.WriteLine("id: " + j + " map: [" + name + "]");
                }
            }
    ...
    public void loadImageDataCharPart(Message msg)
    {
        try
        {
            sbyte b = msg.reader().readByte();// type
            short num = msg.reader().readShort();// id
            string path = string.Empty + num;
            int num2 = msg.reader().readInt();//arrImg.length
            sbyte[] data = new sbyte[num2];
            msg.reader().read(ref data);// read data arrImg
            int num3 = 0;
            ...
            if (num3 > 0)
            {
                ...
                msg.reader().read(ref data2);// read arrData
            ...
            else if (b == 113)
            {
                ...
                DataSkillEff effMatNa = MainObject.getEffMatNa(num);
                if (effMatNa != null)
                {
                    effMatNa.loadData(data2);
                }
            }
            MsgDialog.curupdate++;
        }
        ...
        try
        {
            ...
            if (b != 100)
            {
                ...
                if (b == 3)
                {
                    ...
                    sbyte tem = msg.reader().readByte();
                    int id3 = msg.reader().readUnsignedByte();
                    MainObject mainObject2 = MainObject.get_Object(iD, tem);
                    if (mainObject2 != null)
                    {
                        mainObject2.removeDataSkillEff(id3);
                    }
                    return;
                }
                if (b == 101)
                    ...
                    case 0:
                        {
                            ...
                            MainObject mainObject4 = MainObject.get_Object(iD3, tem3);
                            if (mainObject4 != null)
                            {
                                mainObject4.addEffAutoFromsv(num4, mainObject4.x, mainObject4.y, 0, 0, 0, 0, array2, lvpaint, time, canmove, b3, b4);
                            }
                            break;
                        }
                    case 1:
                        {
                            ...
                            if (b7 != 0 && num7 != 0)
                            {
                                MainObject mainObject5 = MainObject.get_Object(num7, b8);
                                if (mainObject5 != null)
                                {
                                    mainObject5.hOne = b7;
                                }
                    ...
                    case 2:
                        {
                            ...
                            MainObject mainObject3 = MainObject.get_Object(iD2, tem2);
                            if (mainObject3 != null)
                            {
                                if (num5 < 0)
                                {
                                    mainObject3.addDataEff(num4, array2, b3, b4);
                                }
                                else if (num5 > 0)
                                {
                                    long timelive2 = num5 + mSystem.currentTimeMillis();
                                    mainObject3.addDataEff(num4, array2, b3, b4, timelive2, b5);
                                }
                                else
                                {
                                    mainObject3.addDataEff2(num4, array2, b3, b4, 0L, b5);
                                }
                            }
                            break;
                        }
            ...
            else
            {
                ...
                MainObject mainObject6 = MainObject.get_Object(iD4, b9);
                if (mainObject6 == null)
                {
                    return;
                }
    ...
    private MainItem createItemFromMessage(Message msg)
    {
        try
        {
            ...
            sbyte isLock = msg.reader().readByte();
            return new MainItem(iD, itemName, imageId, tier, b3, b, typeMain, array, b2, false, -1, 0L, level, canSell, canTrade, timeUse, 0, isLock);
        }
        catch (Exception)
        {
        }
        ...
        try
        {
            ...
            if (b == 0)
            {
                ...
                else if (b2 == 3)
                {
                    ...
                    for (int j = 0; j < b5; j++)
                    {
                        ...
                        mainItem = new MainItem(iD, text, imageId, tier, b8, b6, b3, array, b7, false, -1, 0L, level, canSell, canTrade, timeUse, 0, isLock, timeDefault, long.Parse(s));
            ...
            else if (b == 1)
            {
                ...
                else if (b2 == 3)
                {
                    ...
                    MainItem mainItem3 = MainItem.MainItem_Item(iD3, itemName, imageId2, plusItem, b19, b17, b3, array2, b18, false, -1, 0L, lvItem, issell3, istrade3, timeUse2, 0, isLock2, timeDefault2, long.Parse(s2));
    ...
    public void Rebuild_Item(Message msg)
    {
        try
        {
            ...
            else if (b == 4)
            {
                ...
                TabRebuildItem.itemRe = MainItem.MainItem_Item(iD2, itemInventory2.itemNameExcludeLv, itemInventory2.imageId, itemInventory2.tier, itemInventory2.colorNameItem, itemInventory2.classcharItem, b4, itemInventory2.mInfo, itemInventory2.type_Only_Item, false, itemInventory2.IdTem, itemInventory2.priceItem, (short)itemInventory2.LvItem, itemInventory2.canSell, itemInventory2.canTrade, 0, 0, 0);
        ...
        try
        {
            ...
            else if (b == 1)
            {
                ...
                if (TabRebuildItem.itemPlus != null && TabRebuildItem.itemFree != null)
                {
                    ...
                    GameCanvas.menu2.startAt_NPC(mVector3, T.hoichuyendo + TabRebuildItem.itemPlus.itemName + T.qua + TabRebuildItem.itemFree.itemName + "? " + T.phi + ": " + num + " " + T.gem + ".", Menu2.IdNPCLast, 2, false, 0);
                }
            }
            else if (b == 2)
            {
    ...
    public void Help_From_Server(Message msg)
    {
        try
        {
            ...
            if (mainObject != null && !mainObject.isRemove)
            {
                ...
                mVector3.addElement(o);
                GameCanvas.menu2.startAt_NPC(mVector3, MainObject.strHelpNPC[0], b, 2, false, 2);
            }
        }
        catch (Exception)
        {
    ...
    public void Clan(Message msg)
    {
        try
        {
            ...
            switch (b)
            {
                ...
                case 15:
                    {
                        sbyte b2 = msg.reader().readByte();// = 1
                        sbyte b3 = msg.reader().readByte();// =0
                        Debug.Log("type=" + b2 + " action=" + b3);//// b2 == 1
                        if (b3 == 0)
                        {
                            int idClan = msg.reader().readInt();
        ...
        try
        {
            ...
            switch (b)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    GameScreen.checkAddEff(94, mainObject.x, mainObject.y, num2, num, tem, idFrom, 1, false);
                    if (b2 > 0)
                    {
                        LoadMap.timeVibrateScreen = b2;
                    }
                    break;
                case 5:
                    GameScreen.checkAddEff(100, mainObject.x, mainObject.y, num2, num, tem, idFrom, 1, false);
                    if (b2 > 0)
                    {
                        LoadMap.timeVibrateScreen = b2;
                    }
                    break;
                case 6:
                    GameScreen.checkAddEff(101, mainObject.x, mainObject.y, num2, num, tem, idFrom, 1, false);
                    if (b2 > 0)
                    {
                        LoadMap.timeVibrateScreen = b2;
                    }
                    break;
                case 7:
                    GameScreen.checkAddEff(102, mainObject.x, mainObject.y, num2, num, tem, idFrom, 1, false);
                    if (b2 > 0)
                    {
                        LoadMap.timeVibrateScreen = b2;
                    }
                    break;
                case 8:
                    GameScreen.checkAddEff(107, mainObject.x, mainObject.y, num2, num, tem, idFrom, 1, false);
                    if (b2 > 0)
                    {
                        LoadMap.timeVibrateScreen = b2;
                    }
                ...
                case 9:
                    ...
                    GameScreen.checkAddEff(103, mainObject.x, mainObject.y, num2, num, tem, idFrom, 1, false);
                    if (b2 > 0)
                    {
                        LoadMap.timeVibrateScreen = b2;
                    }
    ...
    public void EffWeather(Message msg)
    {
        try
        {
            ...
            else
            {
                ...
                GameScreen.AddEffWeather(b, true, num, num2);
            }
        }
        catch (Exception)
        {
    ...
    public void Rebuild_Wing(Message msg)
    {
        try
        {
            ...
            else if (b == 2)
            {
                ...
                {
                    TabRebuildItem.itemWing = MainItem.MainItem_Item(num2, itemInventory2.itemNameExcludeLv, itemInventory2.imageId, itemInventory2.tier, itemInventory2.colorNameItem, itemInventory2.classcharItem, 3, itemInventory2.mInfo, itemInventory2.type_Only_Item, false, itemInventory2.IdTem, itemInventory2.priceItem, (short)itemInventory2.LvItem, itemInventory2.canSell, itemInventory2.canTrade, 0, 0, 0);
                }
            }
            else if (b == 5)
            {
    ...
    public void UpdateDataAndroid(Message msg)
    {
        try
        {
            ...
            Debug.LogError("IndexCharPar: " + GameCanvas.IndexCharPar + "maxupdate: " + maxupdate);
            // index = 1157
            // version = -123
        }
        catch (Exception)
                ...
                case 1:
                    {
                        ...
                        if (mainObject != null)
                        {
                            mainObject.setEffectauto(b2, r, b);
                        }
                        break;
                    }
            }
            ...
            if (b == 0)
            {
                ...
                for (int i = 0; i < b2; i++)
                {
                    ...
                    if (b3 == 3)
                    {
                        ...
                        MainItem o = new MainItem(iD, itemName, imageId, tier, b6, b4, b3, array, b5, false, -1, 0L, level, 0, 0, -1, 0, 0);
        ...
        try
        {
            switch (msg.reader().readByte())
            {
                ...
                case 2:
                    {
                        short num6 = msg.reader().readShort();
                        MainObject mainObject2 = GameScreen.findChar(num6);
                ...
                case 3:
                    {
                        ...
                        for (int i = 0; i < b; i++)
                        {
                            ...
                            if (b2 == 3)
                            {
                                ...
                                sbyte typeMoney = msg.reader().readByte();
                                MainItem mainItem = MainItem.MainItem_Item(num, itemName, imageId, plusItem, b5, b3, 3, array, b4, false, num, 0L, lvItem, 0, 0, 0, typeMoney, 0);
                ...
                case 0:
                    {
                        short id3 = msg.reader().readShort();
                        string name = msg.reader().readUTF();
                        MainObject mainObject3 = GameScreen.findMonster(id3);
                        if (mainObject3 != null)
                        {
                            mainObject3.SetnameOwner(name);
                        }
                        break;
                    }
                case 1:
            ...
            switch (msg.reader().readByte())
            {
                ...
                case 3:
                    ...
                    if (TabRebuildItem.isNextRebuild == 3)
                    {
                        ...
                        mainItem2 = new MainItem(iD2, itemName, imageId, tier, b6, b4, b3, array, b5, false, -1, 0L, level, canSell, canTrade, timeUse, 0, isLock, timeDefault, long.Parse(s));
